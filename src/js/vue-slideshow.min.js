...
! function(t, i, e) {
    ...
    o("style.v-slideshow-style") || o("head").insertAdjacentHTML("beforeend", '<style class="v-slideshow-style">.v-slideshow-container{position:relative;width:100%;height:100%;margin:0;padding:0;overflow:hidden;background:#fff}.v-slideshow-wrapper{position:absolute;height:100%;margin:0;padding:0}.v-slideshow-box,.v-slideshow-box a,.v-slideshow-box img{position:absolute;width:100%;height:100%}.v-slideshow-box a,.v-slideshow-box img{display:block;border:0}.v-slideshow-box-fade{opacity:0;transition:.7s;display:none}.v-slideshow-box-show{opacity:1}.v-slideshow-box-block{display:block}.v-slideshow-box.v-slideshow-block{display:block}.v-slideshow-dot{position:absolute;height:10px;bottom:20px;left:50%;transform:translateX(-50%)}.v-slideshow-dot i{display:block;float:left;cursor:pointer;width:10px;height:10px;border-radius:50%;background:rgba(255,255,255,.5);margin:0 5px;transition:.3s}.v-slideshow-dot i.active{background:rgba(255,255,255,1)}.v-slideshow-arrow i{display:block;width:40px;height:40px;background-image:url("data:image/svg+xml;base64,");background-color:rgba(0,0,0,.5);background-position:center;background-repeat:no-repeat;position:absolute;top:50%;border-radius:50%;cursor:pointer;transform:translateY(-50%)}.v-slideshow-arrow i:first-child{left:15px}.v-slideshow-arrow i:last-child{right:15px;transform:translateY(-50%) rotate(180deg)}</style>\n\t\t'), e.component("vue-slideshow", {
        ...
        props: ["data", "config"],
        computed: { wrapperStyle: function() { return { width: "slide" === this.config.effect ? 100 * (this.data.length + 2) + "%" : "100%", transform: "slide" === this.config.effect && "translateX(-" + 100 / (this.data.length + 2) + "%)" } }, boxClass: function() { return function(t) { return { "v-slideshow-box": !0, "v-slideshow-box-fade": "fade" === this.config.effect && !0, "v-slideshow-box-show": "fade" === this.config.effect && 0 === t, "v-slideshow-box-block": "fade" === this.config.effect && 0 === t } } }, boxStyle: function() { return function(t) { return { width: ("slide" !== this.config.effect ? 100 : 100 / (this.data.length + 2)) + "%", left: "slide" === this.config.effect && 100 / (this.data.length + 2) * t + "%" } } }, dotIClass: function() { return function(t) { return { active: 0 === t } } } },
        methods: {
            slide: function(t) {
                var e = i.VueSlideShowIDCache[this.$el.getAttribute("data-id")];
                e.animated = !0;
                var o = 100 / (this.data.length + 2),
                    a = this.data.length;
                this.dotChange(t, this.config.dot), -1 === t && this.dotChange(a - 1, this.config.dot), t === a && this.dotChange(0, this.config.dot);
                var s = this.$el.querySelector(".v-slideshow-wrapper");
                s.style.transition = ".7s", requestAnimationFrame(function() { s.style.transform = "translateX(-" + o * (t + 1) + "%)" });
            ...
            fade: function(t) {
                var e = i.VueSlideShowIDCache[this.$el.getAttribute("data-id")];
                e.animated = !0, this.dotChange(t, this.config.dot), a(".v-slideshow-box", this.$el).forEach(function(o, a) { if (a === t) { o.classList.add("v-slideshow-box-block"); var s = i.setTimeout(function() { o.classList.add("v-slideshow-box-show"), i.clearTimeout(s) }, 16) } else { o.classList.remove("v-slideshow-box-show"); var n = i.setTimeout(function() { o.classList.remove("v-slideshow-box-block"), i.clearTimeout(n), e.animated = !1 }, 700) } })
            },
            dotChange: function(t, e) { i.VueSlideShowIDCache[this.$el.getAttribute("data-id")].imageIndex = t, ("string" == typeof e ? [].slice.call(o(e).children) : a(".v-slideshow-dot i", this.$el)).forEach(function(i, e) { i.classList.remove("active"), e === t && i.classList.add("active") }) },
            ...
            arrowEvent: function(t) {
                if (!i.VueSlideShowIDCache[this.$el.getAttribute("data-id")].animated) {
                    var e = i.VueSlideShowIDCache[this.$el.getAttribute("data-id")];
                    t ? ++e.imageIndex > this.data.length - 1 && "slide" !== this.config.effect && (e.imageIndex = 0) : --e.imageIndex < 0 && "slide" !== this.config.effect && (e.imageIndex = this.data.length - 1), "fade" === this.config.effect ? this.fade(e.imageIndex) : this.slide(e.imageIndex)
                }
            },
            enter: function() { this.config.autoplay && i.clearInterval(i.VueSlideShowIDCache[this.$el.getAttribute("data-id")].autoTimer) },
            leave: function() { this.config.autoplay && this.play() },
            play: function() {
                var t = this;
                i.VueSlideShowIDCache[this.$el.getAttribute("data-id")].autoTimer = i.setInterval(function() { t.arrowEvent(1) }, ~~this.config.autoplay)
            }
        },
        mounted: function() {
            var t = this;
            i.VueSlideShowIDCache || (i.VueSlideShowIDCache = {}), i.VueSlideShowIDCache[this.$el.getAttribute("data-id")] = { imageIndex: 0, animated: !1, autoTimer: null }, this.config.autoplay && this.play();
            var e = this.$el.getAttribute("data-custom-arrow");
            e && (e = e.split("|"), o(e[0]).onclick = function() { return t.arrowEvent(0) }, o(e[1]).onclick = function() { return t.arrowEvent(1) });
            var a = this.$el.getAttribute("data-custom-dot");
            a && [].slice.call(o(a).children).forEach(function(i, e) { e > t.data.length - 1 || (i.onclick = function() { return t.dotEvent(e, t.config.dot) }) })
        }
    }), e.prototype.VueSlideShow = function(t, i) { return o(t).innerHTML = '<vue-slideshow :data="images" :config="config"></vue-slideshow>', new e({ el: t, data: { images: i.images, config: i.config } }) }
}(document, window, Vue);